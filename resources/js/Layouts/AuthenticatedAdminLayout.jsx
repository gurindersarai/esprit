...
<div className="min-h-screen flex flex-row bg-white dark:bg-gray-900">
  <div className="flex flex-col w-56 bg-white dark:bg-gray-800 overflow-hidden">

    <ul className="flex flex-col py-4">
      <li>
        <NavLink2 href={route('admin.dashboard')} active={route().current('admin.dashboard')}>
         Dashboard
         </NavLink2>
      </li>
      <li>
      <NavLink2 href={route('admin.users.index')} active={route().current('admin.users.index')}>
         Users
         </NavLink2>
      </li>
      {/* <li>
      <NavLink2  active={route().current('admin.logout')} method="post" href={route('admin.logout')} as="button">
         Logout
         </NavLink2>
      </li> */}
    </ul>
